...
def get_ranges(red_range, green_range, blue_range, rgb_image):
    ...
    if (plotting):
        ...
        if True:
            ...
            ax[1][0].set_title("rgb_filt")
            ax[1][0].imshow(rgb_filt)
            ax[1][0].set_title("img_thresh")
            ax[1][1].imshow(img_thresh_RGB)
            ax[1][2].set_title("rgb_image")
            ax[1][2].imshow(rgb_image)
